...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Khand:wght@400;600;700&display=swap" rel="stylesheet">
    <style>
        ...
        <div class="p-6 pb-24">
            ...
            <div id="resultArea" class="hidden mt-6 text-center">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    <button onclick="shareOnWhatsapp()" class="animate-bounce col-span-2 bg-green-500 text-white font-bold py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-green-600">
